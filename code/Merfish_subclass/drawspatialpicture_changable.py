...
BASE_OUT_DIR = r"E:\zaw\2511\mouseMerfish_zhuang_subclass\ws0.2_ss0.1\Mouse1_strict1to1_PLOTS_ROI_MATCHED"
TABLES_DIR = os.path.join(BASE_OUT_DIR, "tables")
PAIRS_FILE = os.path.join(TABLES_DIR, "Mouse1_strict_pairs_excludeLayer1.tsv")

CLUSTER_FILE_OVER3 = r"E:\zaw\2511\mouseMerfish_zhuang_subclass\ws0.2_ss0.1\mouse_subclass_cluster_total_over3.txt"
CLUSTER_FILE_FALLBACK = r"E:\zaw\2511\mouseMerfish_zhuang_subclass\ws0.2_ss0.1\mouse_subclass_cluster_total.txt"
